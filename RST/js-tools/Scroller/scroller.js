    ...
    var methods = {
        moveto: function (args) {
            return this.each(function () {
                var selObject = $(this);
                opt = selObject.data('scroller').options;
        ...
        init: function (options) {
            var defaultVal = {
                Direction: 'h',
                ItemSelector: '.rst-scroller-item',
                Step: 50,
                OnInit: null,
                OnInitComplete: null,
                OnMove: null
            ...
            return this.each(function () {
                ...
                var selObject = $(this);
                var data = selObject.data('scroller');

                var mouseover = false;

                if (!data) { selObject.data('scroller', { options: obj }); }

                if (obj.Direction == "h") {
                    selObject.data('scroller-dir', 'right');
                }
                else if (obj.Direction == "v") {
                    selObject.data('scroller-dir', 'down');
                }
