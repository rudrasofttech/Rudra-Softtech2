...
export default function EditCard() {
    ...
    return <div >
        ...
        {website !== null ? <div className="container-fluid border-top">
            <div className="row">
                <div className="col-12 " style={{overflowY:"auto", height:"calc(100vh - 57px)" }}>
                    <div className='sticky-lg-top' style={{ top: "55px" }}>
                        <HtmlIframe id={website.id} navigate={navigate} dummy={dummy} />
                    </div>
                </div> 
            </div>
            <Modal show={showEditCompanyModal} onHide={() => setShowEditCompanyModal(false)} size="lg" centered>
                    ...
                    <Modal show={showEditContactModal} onHide={() => setShowEditContactModal(false)} size="lg" centered>
                        <Modal.Header closeButton>
                    ...
                    <Modal show={showEditPhoneModal} onHide={() => setShowEditPhoneModal(false)} size="md" centered>
                        <Modal.Header closeButton>
                    ...
                    <Modal show={showEditSocialModal} onHide={() => setShowEditSocialModal(false)} size="md" centered>
                        <Modal.Header closeButton>
                    ...
                    <Modal show={showEditThemeModal} onHide={() => setShowEditThemeModal(false)} size="md" centered>
                        <Modal.Header closeButton>
                        ...
                        <Modal.Body>
                            <ChooseTheme
                                ...
                                initialThemeId={website.themeId}
                            />
                        </Modal.Body>
                    </Modal>
                    <Modal show={showEditPhotosModal} onHide={() => setShowEditPhotosModal(false)} size="lg" centered>
                        <Modal.Header closeButton>
