...
class LinkListThemeList extends Component {
    constructor(props) {
        super(props);
        this.state = {
            themes: [],
    ...
    fetchThemes = (page = this.state.page) => {
        ...
        fetch(`${API.GetURL()}/UserWebsiteTheme?page=${page}&psize=${this.state.pageSize}&wstype=2`, {
            method: 'get',
            headers: {
            ...
            return (
                <div>
                    ...
                    <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom sticky-top bg-white">
                        <h1 className="h2"><img src={template} className="img-fluid icon-large me-2" /> Link List Themes</h1>
...
export default LinkListThemeList;